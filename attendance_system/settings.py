...
MIDDLEWARE = [
    ...
    'attendance.middleware.AdminAccessMiddleware',
...
# اگر DATABASE_URL وجود داشت از PostgreSQL استفاده کن، در غیر این صورت SQLite
...
LOGIN_REDIRECT_URL = 'attendance:student_list'
